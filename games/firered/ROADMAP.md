...
| 2026-07-29 | 4.0 | Created regenerate_intr.py. Extracted intr.c (0x2B80 - 0x7350) and integrated into build pipeline. Hit literal pool swap on sub_8002B80 so it remains an asm wrapper. Decompiled sub_8002B9C, BB0, BC4, BD8 into pure C successfully. |
